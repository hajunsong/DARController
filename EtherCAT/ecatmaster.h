...
class ecatmaster
{
    ...
    private:
        ...
        void error_code_display(uint32_t code);
...
//        vector<int> cur
    ...
    public:
        ...
        /*!
         * \brief master connect slave device add
         * \param v_local_slave_num         : slave number, integer
         * \param v_local_slave_models      : slave devie name, character
         * \param v_local_vendor_name       : slave vendor name, character
         * \param v_local_vendorID          : slave vendor id, unsigned int
         * \param v_local_productCODE       : slave product code, unsigned int
         * \param v_local_is_servo_driver   : ,boolean
         * \return
         */
        ...
        /*!
        * \brief master ready
        * \param v_local_slave_count  : slave total count, integer
        * \param v_local_domain_count : domain total count, integer
        * \param v_local_sync_ctime   : free run sycle time, 1000000 = 1ms, unsigned long
        * \param v_local_sync_stime   : sync run sycle time, unsigned long
        * \param v_local_refcnt       : ref count, unsigned long
        * \param v_local_dc_flag      : dcmod flag, integer
        * \param v_local_servo_flag   : servo driver check, boolean
        * \return
        */
        ...
        /* ADDED */
        uint32_t f_oper_sdo_read(int v_local_slave_number,
                                         uint16_t v_local_index,
                                         uint16_t v_local_subindex,
                                         COMMUNICAT_SIZE_TYPE v_local_datatype);
