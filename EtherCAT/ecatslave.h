...
class ecatslave
{
    ...
    public :
        ...
        int             v_global_tar_control_word       = 0;
        ...
        uint32_t        v_global_cur_err_state_num      = 0;
        std::string     v_global_cur_err_state_msg      = "";
    ...
    public:
        ...
        /* ADDED */
        virtual void f_oper_send_pos_cmd(long val);
        virtual void f_oper_send_tor_cmd(long val);
        virtual void f_oper_to_cst();
        virtual void f_oper_to_csp();
        virtual void f_oper_DIO(int mode);
};
