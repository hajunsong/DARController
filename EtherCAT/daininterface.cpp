                         ...
                         const uint16_t v_local_data)
{
    ...
    v_local_ret = f_oper_sdo_write(v_local_slave_number, v_local_index, v_local_subindex, 2, (uint8_t*)&v_local_wr_data);
    return v_local_ret;
#endif
}
                         ...
                         uint8_t *v_local_data)
{
    ...
    v_local_sdo_read.io_flag  = C_GLOBAL_IO_READ;
                         ...
                         const uint8_t *v_local_data)
{
    ...
    v_local_ret = f_oper_sdo_read(v_local_slave_number, v_local_index, v_local_subindex, 1, (uint8_t*)v_local_data);
    return v_local_ret;
#endif
}
...
int daininterface::f_oper_sdo_read_16( uint16_t v_local_slave_number,
                         uint16_t v_local_index,
                         uint16_t v_local_subindex,
                         const uint16_t *v_local_data)//const uint8_t *v_local_data)
{
//#if 1
//    int v_local_ret;

//    v_local_ret = f_oper_sdo_read(v_local_slave_number, v_local_index, v_local_subindex, 2, (uint8_t*)v_local_data);
//    return v_local_ret;
//#endif
    int v_local_ret;
    dec_sdo16_data_t  v_local_sdo_read;
    if (f_oper_open() < 0 ) return -1;
    ...
    v_local_sdo_read.subindex = v_local_subindex;
    v_local_sdo_read.io_flag  = C_GLOBAL_IO_READ;
    v_local_sdo_read.len 	  = 2;
    v_local_ret = ioctl(v_global_dec_fd, IOCTL_DEC_SDO_GET_DATA, &v_local_sdo_read);

    return 	v_local_sdo_read.data[0];
}
...
int daininterface::f_oper_sdo_read_32( uint16_t v_local_slave_number,
                         uint16_t v_local_index,
                         uint16_t v_local_subindex,
                         const uint32_t *v_local_data)//const uint8_t *v_local_data)
{
#if 1
    int v_local_ret;

    v_local_ret = f_oper_sdo_read(v_local_slave_number, v_local_index, v_local_subindex, 4, (uint8_t*)v_local_data);
    return v_local_ret;
#endif
}
